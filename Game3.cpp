...
void checkWinner() {
	...
	SetFontSize(30);
	DrawFormatString(180, 240, Blackcolor, "● : %d個", b);
	DrawFormatString(180, 290, Whitecolor, "● : %d個", w);
	DrawString(130, 380, "-- Esc Back --", Bluecolor);

	//勝者を表示
	SetFontSize(25);
	if (b < w)
		DrawString(180, 170, "●Winner!", Blackcolor);
	else if (b > w)
		DrawString(180, 170, "●Winner!", Whitecolor);
	else
		DrawString(190, 170, "～Draw～", Redcolor);
}
